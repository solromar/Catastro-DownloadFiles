...
class CatastroRefCatController extends AbstractController
{
    ...
    public function consultaDnprcAction()
    {
        ...
        //-----------------------------------------------Comienzo de ejecucion de codigo para $refCat de 20 caracteres  -------------------------------------------------
        if (strlen($refCat) === 20) {
            ...
            $responseData = [
                ...
                $responseData['Listado Construcciones'] = $consData,
            ...
            $responseData['Listado Inmuebles'] = $rcdpnData;
            //-----------------------------------------------FIN de ejecucion de codigo para $refCat de 14 caracteres  -------------------------------------------------------

            // ---------------------------------------------- Si la longitud no es valida, mostrar un mensaje de error -------------------------------------------------------

        } else {
            $responseData = ['ERROR' => 'Longitud Invalida, por favor verifique'];
        }
        // -------------------------------------------------------------------------------------------------------------------------------------------------------------------
